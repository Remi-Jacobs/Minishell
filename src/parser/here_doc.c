...
/*   Updated: 2024/11/23 21:06:39 by ojacobs          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// static void ft_here_doc_parent(t_shell_state *shell_state, pid_t child_pid, int status)
// {
// 	int signal_code;
...
// 	else if (child_pid > 0)
// 	{
// 		ft_here_doc_parent(shell_state, child_pid, &status);
// 		// waitpid(child_pid, &status, 0);
